...
This script creates a Sankey Diagram showing the flow from original property accommodation types of HO approaches to the final outcome property accommodation type.
...
raw_data <- read_csv("/raw_data/file.csv")
