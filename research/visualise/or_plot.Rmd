...
This rmarkdown script produces Odds Ratio plots. Here it was done for the Glasgow sample of PREVENT1 data set. 
...
The OR graph only includes ORs that had significant p-values in the LR model and were included 
